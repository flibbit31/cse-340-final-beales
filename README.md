...
Note: Much of the code draws from CSE-340 Practice Site code.
...
Admins: Admins have all permissions of lesser roles. They may create, archive, and unarchive projects. They may also change the status of any task (though it is recommended that they first contact the creator and/or employee who accepted the task). They may also change the role of any user (besides themself). I am considering whether or not admins should be able to change the role of another admin (this may be necessary if an admin account becomes compromised).
